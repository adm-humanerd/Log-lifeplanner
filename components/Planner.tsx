    ...
    return (
      <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex flex-1 overflow-hidden px-6 pb-6 gap-6">
                  ...
                  <div key={task.id} className="group flex items-start gap-3 p-3 rounded bg-white border border-stone-100 hover:border-stone-300 transition-colors">
                    <button 
                      ...
                      className={`mt-1 w-4 h-4 rounded border flex items-center justify-center transition-colors flex-shrink-0 ${
                          task.completed ? 'bg-ink border-ink' : 'border-stone-300 hover:border-ink'
                      }`}
                    >
          ...
          {/* Notes Column */}
          <div className="w-1/3 flex flex-col border-l border-stone-100 pl-6 hidden md:flex">
             <h3 className="font-serif text-xl text-ink mb-4 flex-shrink-0">Field Notes</h3>
             <textarea 
                className="w-full flex-1 bg-paper resize-none focus:outline-none text-ink/80 text-sm leading-relaxed font-serif"
